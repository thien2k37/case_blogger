...
<section  class="main-content">
    <header class="header">
        <div class="control">
            <div class="nav-item">
                <a> <button type="button" class="btn btn-outline-light" ><img src="/img/logo.png"></button></a>
            </div>
        </div>
        <div class="sign" style="text-align: center">
            <a href="#" class="sign-items" style="color: #FFFFFF"><h4>BLOG</h4></a>
        </div>
        <div class="option" style="border: #DDDDDD">
            <div class="sign">
                <a href="#" class="sign-items" style="color: #FFFFFF"> <h4>Trang Chủ</h4></a>
            </div>
        </div>
    </header>
</section>
        ...
        <div class="form-container sign-in-container">
            <form action="#" method="post">
                ...
                <div class="social-container">
                    ...
                    <a href="#" class="social"><i class="fab fa-facebook-f"></i><img src="../img/9.png"></a>
                    <a href="#" class="social"><i class="fab fa-facebook-f"></i><img src="../img/11.jpg"></a>
                </div>
...
<style>
    ...
    * {
    ...
    .overlay {
        background: #97212D;
        background: -webkit-linear-gradient(to right, #97212D, #97212D);
        background: linear-gradient(to right, #97212D, #97212D);
